...
import { GCP_COLORS } from "./shared";

interface GcpActualTabProps {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex rounded-lg bg-gray-100 p-1">
          <button
            className="rounded-md bg-white px-4 py-1.5 text-sm font-medium text-blue-500 shadow"
            aria-current="true"
          >
            Actual Costs
          </button>
      ...
      <div
        ...
        style={{ background: "linear-gradient(to right, #4285F4, #8AB4F8)" }}
      >
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <p className="text-sm font-medium" style={{ color: "rgba(255,255,255,0.85)" }}>
                Actual GCP Infrastructure Cost
              </p>
              <span
            ...
            <p className="mt-1 text-sm" style={{ color: "rgba(255,255,255,0.85)" }}>
              Across {summary?.project_count || 0} projects · {summary?.service_count || 0} services ·{" "}
              {summary?.days_in_range || 0} days
            </p>
          </div>
