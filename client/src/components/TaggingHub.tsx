          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            {availableTagValues.length > 0 && (
              <div className="relative" data-tag-value-filter-dropdown>
                ...
                >
                  <svg className={`h-3.5 w-3.5 ${selectedTagValueFilters.length > 0 ? "text-[#FF3621]" : "text-gray-500"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            {availableTagKeys.length > 0 && (
              <div className="relative" data-tag-filter-dropdown>
                ...
                >
                  <svg className={`h-3.5 w-3.5 ${selectedTagFilters.length > 0 ? "text-[#FF3621]" : "text-gray-500"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                  </svg>
                  Filter
