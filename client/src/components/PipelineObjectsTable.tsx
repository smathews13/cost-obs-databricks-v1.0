      ...
      <div className="mb-4 flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          ...
          <div className="relative w-52 shrink-0">
            ...
            <input type="text" placeholder="Search jobs & pipelines..." value={search} onChange={(e) => { setSearch(e.target.value); setCurrentPage(1); }} className="rounded-full border border-gray-200 bg-white py-1.5 pl-9 pr-4 text-sm placeholder:text-gray-400 focus:border-[#FF3621] focus:outline-none focus:ring-1 focus:ring-[#FF3621] w-full" />
          </div>
        </div>
      </div>
