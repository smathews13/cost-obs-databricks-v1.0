...
interface AzureActualTabProps {
  azureActualData: AzureActualDashboardBundle;
  /** The cost-mode toggle (Actual / Estimated pill row) rendered by the shell */
...
export function AzureActualTab({
  azureActualData,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex rounded-lg bg-gray-100 p-1">
          <button
            className="rounded-md bg-white px-4 py-1.5 text-sm font-medium text-blue-600 shadow"
            aria-current="true"
          >
            Actual Costs
          </button>
      ...
      <div
        ...
        style={{ background: "linear-gradient(to right, #0078D4, #50B4F9)" }}
      >
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <p className="text-sm font-medium" style={{ color: "rgba(255,255,255,0.85)" }}>
                Actual Azure Infrastructure Cost
              </p>
              <span
                className="rounded-full px-2 py-0.5 text-xs"
                style={{ backgroundColor: "rgba(255,255,255,0.2)" }}
              >
                From Cost Management Export
              </span>
              <span
                className="rounded-full px-2 py-0.5 text-xs"
                style={{ backgroundColor: "rgba(255,255,255,0.2)" }}
